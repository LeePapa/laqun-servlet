...
@WebServlet({"/api/webServer/getAddWxHistory"})
public class getAddWxHistory extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareStatement("select * from addWxHistory where wxid like ? limit ?, ?");
            ...
            stmt = conn.prepareStatement("select count(*) as total from addWxHistory  where wxid like ?");
            stmt.setString(1, "%" + wxid + "%");
