...
@WebServlet({"/api/webServer/delTalkChatRoom"})
public class delTalkChatRoom extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareStatement("delete from talkChatRoom where qunQr = ?");
