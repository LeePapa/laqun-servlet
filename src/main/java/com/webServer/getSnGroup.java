...
@WebServlet({"/api/webServer/getSnGroup"})
public class getSnGroup extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareStatement("select * from snGroup where groupName like ? limit ?, ?");
            ...
            while (res.next()) {
                ...
                jo.put("groupName", res.getString("groupName"));
                jo.put("groupMember", res.getString("groupMember"));
