...
@WebServlet({"/api/webServer/getIp"})
public class getIp extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareStatement("select * from ipConf where ipAddr like ? limit ?, ?");
            ...
            while (res.next()) {
                ...
                jo.put("ipAddr", res.getString("ipAddr"));
                jo.put("useNum", res.getString("useNum"));
                jo.put("lastUseTime", res.getString("lastUseTime"));
                ja.put(jo);
            }
