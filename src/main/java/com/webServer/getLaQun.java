...
@WebServlet({"/api/webServer/getLaQun"})
public class getLaQun extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            while (res.next()) {
                ...
                jo.put("laedNum", res.getString("laedNum"));
                jo.put("lastGetTime", res.getString("lastGetTime"));
                jo.put("priority", res.getString("priority"));
                jo.put("customer", res.getString("customer"));
                jo.put("isBad", res.getInt("isBad"));
                jo.put("friendNum", res.getInt("friendNum"));
                jo.put("canLaNum", res.getInt("laNum") - res.getInt("laedNum"));
                ja.put(jo);
            }
